# What 177 teardowns taught us

*One hundred and seventy-seven famous trading ideas — anomalies, folk strategies, vendor backtests, things
...
![The bench map — 177 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 177 studies on the bench, 176 carry final stamps (study
...
- **29 / 176 signals are statistically real.** About one famous idea in five
  survives autocorrelation-robust inference. The other four-fifths are weak
  (75) or plain noise (72).
- **128 / 176 are mirages once you try to trade them.** Costs, capacity,
  decay, or the discovery that the "edge" was beta all along.
- **Exactly 3 / 176 are investable.** [Storm-Shy](../studies/16-storm-shy/),
...
We sorted the 177 into rough families. The boundaries are judgement calls (is
...
- **Calendar effects are the opposite failure mode: among the most *real* per
  capita (4 of 29) and almost none tradable.** The pattern is genuinely in the
...
Of the 29 statistically real signals, 26 failed or barely survived
...
This page will be wrong eventually — that's the design. One hundred and seventy-seven verdicts is
one hundred and seventy-seven falsifiable claims, each with reproducible code, pinned data

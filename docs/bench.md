...
Of the 450 studies on the bench, 449 carry final stamps (study
...
- **49 / 449 signals are statistically real.** About one famous idea in nine
  survives autocorrelation-robust inference. The other eight-ninths are weak
  (174) or plain noise (226).
- **367 / 449 are mirages once you try to trade them.** Costs, capacity,
  decay, or the discovery that the "edge" was beta all along.
- **Exactly 3 / 449 are investable.** [Storm-Shy](../studies/16-storm-shy/),
...
We sorted the 450 into rough families. The boundaries are judgement calls (is

...
![The bench map — 540 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 540 studies on the bench, 539 carry final stamps (study
...
We sorted the 540 into rough families. The boundaries are judgement calls (is

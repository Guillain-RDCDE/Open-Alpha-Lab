...
![The bench map — 581 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 581 studies on the bench, 580 carry final stamps (study
...
We sorted the 581 into rough families. The boundaries are judgement calls (is

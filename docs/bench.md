...
![The bench map — 556 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 556 studies on the bench, 555 carry final stamps (study
...
We sorted the 556 into rough families. The boundaries are judgement calls (is

# What 500 teardowns taught us

*Five hundred famous trading ideas — anomalies, folk strategies, vendor backtests, things
...
![The bench map — 500 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 500 studies on the bench, 499 carry final stamps (study
...
- **50 / 499 signals are statistically real.** About one famous idea in ten
  survives autocorrelation-robust inference. The other nine-tenths are weak
  (184) or plain noise (265).
- **407 / 499 are mirages once you try to trade them.** Costs, capacity,
  decay, or the discovery that the "edge" was beta all along.
- **Exactly 3 / 499 are investable.** [Storm-Shy](../studies/16-storm-shy/),
...
We sorted the 500 into rough families. The boundaries are judgement calls (is

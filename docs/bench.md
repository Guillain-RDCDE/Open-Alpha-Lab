...
![The bench map — 548 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 548 studies on the bench, 547 carry final stamps (study
...
We sorted the 548 into rough families. The boundaries are judgement calls (is

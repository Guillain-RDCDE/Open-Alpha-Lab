...
![The bench map — 564 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 564 studies on the bench, 563 carry final stamps (study
...
We sorted the 564 into rough families. The boundaries are judgement calls (is

# What 301 teardowns taught us

*Three hundred and one famous trading ideas — anomalies, folk strategies, vendor backtests, things
...
![The bench map — 301 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 301 studies on the bench, 300 carry final stamps (study
...
- **36 / 300 signals are statistically real.** About one famous idea in eight
  survives autocorrelation-robust inference. The other seven-eighths are weak
  (118) or plain noise (146).
- **235 / 300 are mirages once you try to trade them.** Costs, capacity,
  decay, or the discovery that the "edge" was beta all along.
- **Exactly 3 / 300 are investable.** [Storm-Shy](../studies/16-storm-shy/),
...
(11 studies)**. Eleven effects that are *genuinely there in the data* and still
...
We sorted the 300 into rough families. The boundaries are judgement calls (is

# What 361 teardowns taught us

*Three hundred and sixty-one famous trading ideas — anomalies, folk strategies, vendor backtests, things
...
![The bench map — 361 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 361 studies on the bench, 360 carry final stamps (study
...
- **43 / 360 signals are statistically real.** About one famous idea in eight
  survives autocorrelation-robust inference. The other seven-eighths are weak
  (140) or plain noise (177).
- **288 / 360 are mirages once you try to trade them.** Costs, capacity,
  decay, or the discovery that the "edge" was beta all along.
- **Exactly 3 / 360 are investable.** [Storm-Shy](../studies/16-storm-shy/),
...
We sorted the 350 into rough families. The boundaries are judgement calls (is
...
| Research-method demos — [343](../studies/343-data-mining-roulette/) [344](../studies/344-backtest-overfitting/) [345](../studies/345-survivorship-bias/) [346](../studies/346-multiple-testing/) [347](../studies/347-look-ahead-bias/) [348](../studies/348-curve-fitting/) [349](../studies/349-regime-dependence/) [350](../studies/350-dartboard-portfolio/) [355](../studies/355-magnificent-seven/) | 9 | 0 | 0 | 0 |
...
Of the 42 statistically real signals, 39 failed or barely survived
...
This page will be wrong eventually — that's the design. Three hundred and sixty-one verdicts is
three hundred and sixty-one falsifiable claims, each with reproducible code, pinned data

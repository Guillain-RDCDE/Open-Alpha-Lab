...
![The bench map — 574 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 574 studies on the bench, 573 carry final stamps (study
...
We sorted the 574 into rough families. The boundaries are judgement calls (is

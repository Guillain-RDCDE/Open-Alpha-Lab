# What 590 teardowns taught us

*Five hundred and forty famous trading ideas — anomalies, folk strategies, vendor backtests, things
...
![The bench map — 590 studies on a Signal × Tradability grid](bench_map.png)
...
Of the 590 studies on the bench, 589 carry final stamps (study
...
- **52 / 539 signals are statistically real.** About one famous idea in ten
  survives autocorrelation-robust inference. The other nine-tenths are weak
  (193) or plain noise (294).
- **442 / 539 are mirages once you try to trade them.** Costs, capacity,
  decay, or the discovery that the "edge" was beta all along.
- **Exactly 3 / 539 are investable.** [Storm-Shy](../studies/16-storm-shy/),
...
(19 studies)**. Nineteen effects that are *genuinely there in the data* and still
...
We sorted the 590 into rough families. The boundaries are judgement calls (is

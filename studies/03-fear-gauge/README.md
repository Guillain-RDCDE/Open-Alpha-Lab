...
| Axis | Stamp | Why |
|---|---|---|
| **Signal** — is the effect statistically real? | 🟡 `REAL` (level) / 🔴 `NONE` (spike) | VIX≥30 beats a random day by **+1.0% at 1wk** (p≈0.00) and **+1.3% at 1mo** (p≈0.01); but the famous **+30% spike** earns **−0.02% at 1mo** (p≈0.51) — its whole edge is the 2016–2026 window. |

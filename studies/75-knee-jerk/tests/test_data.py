...
def test_reversion_creates_negative_autocorrelation():
    ...
    flat, _ = data.synthetic_daily(n_days=2000, reversion=0.0, seed=75)
    rev, _ = data.synthetic_daily(n_days=2000, reversion=0.30, seed=75)
...
def test_fingerprint_is_stable_and_content_sensitive(coin):
    ...
    other, _ = data.synthetic_daily(n_days=1000, reversion=0.0, seed=99)

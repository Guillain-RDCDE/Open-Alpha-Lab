...
def build_quants():
    cells = [
        md(
            ...
            "**unstable**, and a walk-forward projection carries **no forecast skill** over a "
            "random-phase null.\n\n"
            ...
            "(`examples/verify_real.py`). Methods: Lomb-Scargle periodogram, AR(1) surrogate "
            "envelope, rolling period stability, random-phase walk-forward — see "

...
| **Beats the basket?** | ![Not supported](https://img.shields.io/badge/Not_supported-8b949e?style=flat-square) | It beats the equal-weight basket on only **33%** of plausible "how-many-sectors-to-hold" choices — a coin flip; the best (k = 1) is just the luckiest cell, not a robust edge. |

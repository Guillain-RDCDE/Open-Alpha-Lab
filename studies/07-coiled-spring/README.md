...
| Axis | Stamp | Why |
|---|---|---|
| **Signal** — does the breakout beat just holding the same name? | ![Weak](https://img.shields.io/badge/Weak-dab617?style=flat-square) | Buying the breakout and holding 10 days beats a random same-stock entry by **+1.2%** (20 days: **+1.5%**), but the HAC *t* is only **2.0–2.3**, and at 5 days the excess is no longer significant (*t* ≈ **1.8**) — a *whisper* of real short-term momentum, not the book's fireworks, and not corrected for the universe of TA rules one could have searched. |

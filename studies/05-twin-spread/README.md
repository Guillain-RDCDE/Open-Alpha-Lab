...
| Axis | Stamp | Why |
|---|---|---|
| **Signal** — does the spread actually revert into a profit? | ![None](https://img.shields.io/badge/None-c0392b?style=flat-square) | The minimum-distance pairs **don't reconverge enough to pay**: modern-era gross is **−0.48%/mo** (Sharpe **−0.44**, bootstrap CI **[−0.84, −0.03]**, 98% of resamples negative) — *negative even at a literal zero spread*. The full sample is statistically zero (CI [−0.34, +0.15]). |

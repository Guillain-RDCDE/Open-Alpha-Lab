...
Prefer scripts? [`examples/`](examples/) has `run_synthetic_demo.py` (offline — watch the toolchain tell a real edge from a fake one), `verify_ndx.py`, `sweep_thresholds.py`, `panic_zoom.py`, `compare_indices.py`.

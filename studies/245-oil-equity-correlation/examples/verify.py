"""Real-tape verification — Study 245 (Oil-Equity-Correlation). Regenerates docs/results.md numbers.

Fetches (or reads from cache) the three daily tapes, runs the oil vs equity
...
with --fetch.
    ...
    python studies/245-oil-equity-correlation/examples/verify.py            # cache-only
    python studies/245-oil-equity-correlation/examples/verify.py --fetch    # refresh the tapes
"""
...
from oil_equity_correlation import data, strategy as st  # noqa: E402
...
def main(fetch: bool) -> None:
    ...
    print(f"Equity (SPY) fingerprint: {fp}")
    print()
